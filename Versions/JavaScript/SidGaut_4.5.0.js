...
function darkenTheme(colour) {
	...
	getEl(`html`).css('color-scheme', 'dark');
	getEl(`*`).css('background-color', '#181818');
	getEl(`*`).css('color', `${colour}`);
	getEl(`*`).css('border', `${colour}`);
	getEl(`nav, nav *, a, button`).css('background-color', '#333');
}
